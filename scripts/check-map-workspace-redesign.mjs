...
const css = read("src/app/homes/map-workspace-v2.css");
...
requireText(manifest, '@import "./map-workspace-v2.css" layer(component-appearance);', "final map workspace appearance layer");
