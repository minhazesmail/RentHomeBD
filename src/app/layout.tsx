...
export default async function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    <html lang={locale} data-theme={themePreference} data-resolved-theme={initialResolvedTheme} className={`${inter.variable} ${hindSiliguri.variable}`} suppressHydrationWarning>
      <head>
