-- =============================================================================
-- HISTORICAL SNAPSHOT — Task 2 foundation only
-- =============================================================================
-- DO NOT apply this file alone on a production or development database.
-- The live schema is defined exclusively by supabase/migrations/ (ordered).
-- This file is retained for documentation and early-task reference.
-- =============================================================================

-- RentHomeBD core database schema (Task 2)
-- Once a dedicated Supabase project exists, create migrations with the Supabase
-- CLI and apply the full migration history rather than this snapshot.
...
-- (Additional policies for tenant types, amenities, and media omitted in this
-- historical snapshot — see migrations for the complete current set.)
