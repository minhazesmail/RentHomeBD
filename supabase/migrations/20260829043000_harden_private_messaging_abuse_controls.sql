...
begin
  ...
  select count(*)
  into recent_conversation_count
  from public.conversations c
  where c.renter_id = (select auth.uid())
  ...
  select p.owner_id, p.title, p.public_owner_display_name
  into listing
  ...
  select display_name into renter_name
