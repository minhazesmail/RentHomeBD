...
-- Child listing metadata must also remain frozen once moderation has started.
...
-- Match storage writes to the same editable listing states. Reads remain available to owners.
